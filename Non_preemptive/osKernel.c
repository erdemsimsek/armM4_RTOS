...
#define SYSPRI3		(*(volatile uint32_t *)(0xE000ED20)) /*System Handler Priority Level 3 | Cortex-M Guide p227*/
#define INTCTRL		(*(volatile uint32_t *)(0xE000E004)) /*Interrupt Control and State Register | Cortex-M Guide p227*/
...
/* In nonpreemptive scheduler, task switch occurs after task yield operation */
void osKernelYield(void){
		INTCTRL  = 0x04000000; // it will trigger Systick
}
